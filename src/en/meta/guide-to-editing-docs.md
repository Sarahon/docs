...
Hello! As you may be able to notice, this docs site is completely open source and free to edit on GitHub. You can see the GitHub page for this site at [https://github.com/Goob-Station/docs](https://github.com/Goob-Station/docs).
...
2. Fork the [Goob-Station/docs](https://github.com/Goob-Station/docs) repo on GitHub.
